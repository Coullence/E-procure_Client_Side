...
import { SelectCategoryComponent } from '../manage-tenders/select-category/select-category.component';
...
@Component({
  ...
  styleUrls: ['./tender-requests.component.scss']
})
export class TenderRequestsComponent implements OnDestroy, OnInit {
  ...
  constructor(
    ...
    this.requestAPI.GetTenders_Requests().subscribe(data => {
