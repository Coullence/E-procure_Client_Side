...
@Component({
  selector: 'app-staffrequests',
  templateUrl: './staffrequests.component.html',
  styleUrls: ['./staffrequests.component.scss']
})
export class StaffrequestsComponent implements OnDestroy, OnInit {
