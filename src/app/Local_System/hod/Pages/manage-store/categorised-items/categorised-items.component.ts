...
@Component({
  selector: 'app-categorised-items',
  templateUrl: './categorised-items.component.html',
  styleUrls: ['./categorised-items.component.scss']
})
export class CategorisedItemsComponent implements OnDestroy, OnInit {
  ...
  constructor(
    ...
    this.requestAPI.GetItemsByCategory(id).subscribe(data => {  
...
// Get active category
    this.requestAPI.GetCategoryId(id).subscribe(data => {     
    	...
    	this.activeCategory = data.categoryName;
    });
