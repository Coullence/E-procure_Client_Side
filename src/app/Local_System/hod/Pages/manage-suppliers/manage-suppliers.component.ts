...
export class ManageSuppliersComponent implements OnDestroy, OnInit {
  ...
  constructor(
    ...
    private requestAPI: SupplierService
  ) {
  
    this.requestAPI.GetSuppliers().subscribe(data => {
  ...
  // updateRequestsForm() {
  //   var id = this.userId 
  //     this.requestAPI. UpdateStaffRole(id, this.requestsForm.value).subscribe(res => {
