...
export class ManageEmployeesComponent implements OnInit {
  ...
  displayedColumns: string[] = [ 'employeeName','employeeEmail','employeePhone','jobId','KRA_Pin','requestAs','createdAt','approvalStatus','action'];
  searchKey: string;
  ...
  countNew(){
        this.countService. countApproveEmployee().pipe(first(
      // takeUntil(),
      )).subscribe(count => {
